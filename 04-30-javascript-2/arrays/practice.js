...
//Code Here
let last = (arr) => arr[2]; //I wanted to write with a arrow function and get comfortable with them.
...
function divider(numbersArray) {
  let evens = numbersArray.filter(function(nums) {
    return nums % 2 === 0;
  });
  let odds = numbersArray.filter(function(nums) {
    return nums % 2 !== 0;
  })
